export default {
  ...
  scheduledPush: {
    ...
    saving: '保存中...',
    pushTime: '推送时间',
    pushTimeHint: '每天在此时间推送未完成的任务',
    minPriority: '最低优先级',
    minPriorityHint: '包含此优先级及以上的任务',
    labels: '标签（多选）',
    labelsHint: '选中任意标签的任务都会被推送',
    titleTemplate: '标题模板',
    bodyTemplate: '正文模板（Markdown）',
    providers: '推送方式',
    providersHint: '请至少选择一个推送方式',
    preview: '预览',
    lastPush: '最后推送',
    noConfigs: '还没有配置定时推送',
    createFirst: '创建第一个配置',
    ...
    errorMessage: '错误信息',
    basicSettings: '基本设置',
    filterConditions: '过滤条件（OR 运算）',
    pushContent: '推送内容',
    pushMethods: '推送方式',
    enableConfig: '启用此配置',
    availableVariables: '可用变量：{{count}}, {{date}}, {{tasks}}',
    priority: {
      0: '无优先级',
      1: '很低',
      2: '低',
