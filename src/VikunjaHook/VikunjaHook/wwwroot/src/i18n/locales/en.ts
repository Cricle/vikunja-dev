export default {
  ...
  scheduledPush: {
    ...
    description: 'Push incomplete tasks daily at scheduled time',
    enabled: 'Enabled',
    disabled: 'Disabled',
    ...
    saving: 'Saving...',
    pushTime: 'Push Time',
    pushTimeHint: 'Push incomplete tasks daily at this time',
    minPriority: 'Minimum Priority',
    minPriorityHint: 'Include tasks with this priority and above',
    labels: 'Labels (Multiple)',
    labelsHint: 'Tasks with any selected label will be pushed',
    titleTemplate: 'Title Template',
    bodyTemplate: 'Body Template (Markdown)',
    providers: 'Push Methods',
    providersHint: 'Please select at least one push method',
    preview: 'Preview',
    lastPush: 'Last Push',
    noConfigs: 'No scheduled push configured yet',
    createFirst: 'Create your first configuration',
    ...
    filterConditions: 'Filter Conditions (OR Logic)',
    pushContent: 'Push Content',
    pushMethods: 'Push Methods',
    enableConfig: 'Enable this configuration',
    availableVariables: 'Available variables: {{count}}, {{date}}, {{tasks}}',
    priority: {
      0: 'No Priority',
      1: 'Very Low',
      2: 'Low',
